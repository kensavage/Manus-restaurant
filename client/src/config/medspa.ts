/**
 * MedSpa Industry Configuration
 * All industry-specific content for the MedSpa AI landing page.
 */

import type { IndustryConfig } from "./types";

const HERO_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663403135933/QK76jQwtXKqzF5FUD4qTbh/hero-medspa-U7VxPoL7xbGXrRRRxKkZP2.webp";
const DASHBOARD_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663403135933/QK76jQwtXKqzF5FUD4qTbh/ai-dashboard-mockup-eTc2aPkwJnHiS63VCWWBL2.webp";
const SOCIAL_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663403135933/QK76jQwtXKqzF5FUD4qTbh/social-content-creation-VtF5JUZnvVtNZMfQVfsKjg.webp";
const RECEPTION_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663403135933/QK76jQwtXKqzF5FUD4qTbh/medspa-reception-Ev2uzvdSZC9arzuzCJWYhN.webp";
...
export const medspaConfig: IndustryConfig = {
  ...
  brand: {
    ...
    footerDesc: "AI-powered operations for modern med spas.",
  },

  hero: {
    headline: "The AI Operating System For Your Med Spa",
    subheadline: "Daily social content that fills your feed and an AI appointment system that fills your schedule. No new hires. No missed revenue.",
    ctaLabel: "See How Much Money AI Can Save Your Business",
    ctaSub: "Takes less than 60 seconds",
    backgroundImage: HERO_IMG,
  },

  aiEmployees: [
    { title: "Graphic Designer", description: "Creates stunning images and videos for your med spa brand", iconName: "Palette" },
    { title: "Social Media Marketer", description: "Creates content and schedules posts across all platforms", iconName: "Share2" },
    { title: "Online Review Manager", description: "SMS messages patients after treatments and monitors online reviews", iconName: "Star" },
    { title: "Executive Assistant", description: "Monitors email, drafts replies, answers phone calls, and manages appointments", iconName: "Headphones" },
  ...
  servicesOverview: {
    ...
    headline: "Everything your med spa needs to grow",
    subheadline: "We handle the two biggest operational challenges med spas face: staying visible online and keeping your schedule full.",
    cards: [
      {
        iconName: "Zap",
        title: "AI Content & Posting",
        description: "Daily social media content created, scheduled, and published for your med spa. Instagram, Facebook, and Google Business Profile — handled.",
        variant: "light",
      ...
      },
      {
        ...
        description: "Automated reminders, smart waitlist fills, and no-show tracking that recovers up to $25,000/month in lost revenue.",
        variant: "dark",
  ...
  contentService: {
    ...
    subheadline: "We create, schedule, and publish daily social media content for your med spa. You review and approve in about five minutes a week.",
    howItWorks: [
      { num: "1", title: "We learn your business", desc: "We review your site, offers, and socials so the content sounds like your brand from day one." },
      { num: "2", title: "We build and schedule daily posts", desc: "Treatment highlights, promos, educational content, and appointment drivers built around your business." },
    ...
    socialImageAlt: "Social media content created for med spas — Instagram and Facebook posts displayed on tablet and phone",
    socialImageCaption: "A sample of the content we create and schedule for your med spa across Instagram, Facebook, and Google Business Profile.",
    comparison: {
      headline: "The difference",
      without: {
        label: "Without AutoM8",
        stats: [
          { value: "4", desc: "posts per month" },
          { value: "3hrs", desc: "spent on social per week" },
          { value: "?", desc: "results to show for it" },
        ],
      },
      withAi: {
        label: "With MedSpa AI",
        stats: [
          { value: "60", desc: "posts per month" },
          { value: "5min", desc: "from you per week" },
          { value: "15x", desc: "more visibility for your med spa" },
        ],
      },
    },
  },
  ...
  problem: {
    label: "The Problem",
    headline: "No-shows are costing you $25,000 a month",
    description: "No-shows run 15–30% at most practices. Staff spends 2–4 hours daily calling patients to confirm appointments, reschedule cancellations, and fill gaps in the schedule. Every no-show costs your practice $150–$300 in lost revenue.",
    stats: [
      { value: "15–30%", desc: "average no-show rate" },
      { value: "2–4hrs", desc: "daily on confirmation calls" },
      { value: "$1,200", desc: "lost per day (6 no-shows)" },
      { value: "$25,000", desc: "recoverable per month" },
    ],
    image: RECEPTION_IMG,
    imageAlt: "Med spa front desk staff spending hours on confirmation calls",
    mathCallout: "30 patients/day × 20% no-show = 6 lost appointments × $200 = <strong>$1,200/day lost</strong>",
  },
  ...
  appointmentService: {
    ...
    features: [
      ...
      { iconName: "UserCheck", title: "Provider Onboarding", desc: "New providers are added to the system seamlessly with customized reminder sequences." },
    ],
    dashboardImage: DASHBOARD_IMG,
    dashboardImageAlt: "AI appointment management dashboard showing calendar, waitlist, and no-show analytics",
  ...
  practiceStory: {
    ...
    headline: "From 8 empty slots to a full schedule — without a single phone call",
    steps: [
      { iconName: "Calendar", iconVariant: "dark", title: "Weekend cancellations leave 8 open slots on Tuesday", desc: "A med spa has 8 open slots due to weekend cancellations. Normally, the front desk would spend Monday morning making calls." },
  ...
  homeFaqs: [
    { q: "What do you actually handle for me?", a: "We create the content, schedule it, publish it, and keep the posting cadence moving. For appointment management, we set up and maintain the entire automated reminder and waitlist system. You review and approve in a simple weekly flow, and we handle the rest." },
    ...
    { q: "What kind of content do you create?", a: "Promotions, treatment highlights, educational posts, before-and-after style creative, seasonal offers, and appointment drivers. The content is built around your business, not generic templates." },
  ...
  cta: {
    ...
    items: [
      "Daily posts created for your med spa",
      "Scheduling and publishing handled for you",
      "Content built around your offers, treatments, and goals",
  ...
  quiz: {
    questions: [
      {
        ...
        subtitle: "Average across all providers",
        iconName: "Users",
        options: [
          { label: "10–15 patients", value: 12 },
          { label: "16–25 patients", value: 20 },
          { label: "26–40 patients", value: 33 },
          { label: "40+ patients", value: 50 },
        ],
      },
      {
        id: "noShowRate",
      ...
      },
      {
        ...
        subtitle: "Including treatments, products, and add-ons",
        iconName: "DollarSign",
        options: [
    ...
    emailPlaceholder: "you@yourmedspa.com",
  ...
  results: {
    ...
    roiLabels: {
      annualSuffix: "estimated annual savings for your med spa",
    ...
    includedItems: [
      "Daily social media posts created for your med spa",
      "Scheduling and publishing handled for you",
      "Content built around your offers and treatments",
      "AI appointment reminders and confirmations",
      "Automated waitlist fills for cancelled slots",
      "No-show tracking and revenue recovery reporting",
  ...
  pricing: {
    ...
    heroSubheadline: "Every tier is designed to pay for itself. The appointment system alone can recover $25,000/month in lost revenue.",
    tiers: [
      {
        iconName: "BarChart3",
        label: "Entry Offer",
    ...
    faqs: [
      ...
      { q: "How long does the AI Appointment System take to implement?", a: "Most implementations are completed within 2–4 weeks. This includes system setup, integration with your scheduling software, staff training, and a 2-week monitored launch period." },
